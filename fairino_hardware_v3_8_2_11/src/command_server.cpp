...
std::string robot_command_thread::GetProgramRunErrCode(std::string para){
    ...
    return std::string(std::to_string(res) + "," + std::to_string(errLinNum) + "," + \
            std::to_string(luaErrCode));
}
...
robot_recv_thread::robot_recv_thread(const std::string node_name):rclcpp::Node(node_name){
    ...
    if(_socketfd1 == -1){
        ...
        if(0 != res1){
            ...
            _locktimer = this->create_wall_timer(50ms,std::bind(&robot_recv_thread::_state_recv_callback,this));//创建一个定时器任务用于获取非实时状态数据,触发间隔为100ms
   ...
   /* 如果处于重连流程，不需要再读取，直接返回 */
    ...
    if(!ctrl_state_store_buff.empty()){
        ...
        */
        ...
        msg.exaxistatus1[3] = ctrl_state.exaxis_status[0].exAxisALM;
        msg.exaxistatus1[4] = ctrl_state.exaxis_status[0].exAxisFLERR;
        msg.exaxistatus1[5] = ctrl_state.exaxis_status[0].exAxisNLMT;
        msg.exaxistatus1[6] = ctrl_state.exaxis_status[0].exAxisPLMT;
        msg.exaxistatus1[7] = ctrl_state.exaxis_status[0].exAxisAbsOFLN;
        msg.exaxistatus1[8] = ctrl_state.exaxis_status[0].exAxisOFLIN;
        msg.exaxistatus1[9] = ctrl_state.exaxis_status[0].exAxisHomeStatus;
        ...
        msg.exaxistatus1[3] = ctrl_state.exaxis_status[1].exAxisALM;
        msg.exaxistatus1[4] = ctrl_state.exaxis_status[1].exAxisFLERR;
        msg.exaxistatus1[5] = ctrl_state.exaxis_status[1].exAxisNLMT;
        msg.exaxistatus1[6] = ctrl_state.exaxis_status[1].exAxisPLMT;
        msg.exaxistatus1[7] = ctrl_state.exaxis_status[1].exAxisAbsOFLN;
        msg.exaxistatus1[8] = ctrl_state.exaxis_status[1].exAxisOFLIN;
        msg.exaxistatus1[9] = ctrl_state.exaxis_status[1].exAxisHomeStatus;
        ...
        msg.exaxistatus1[3] = ctrl_state.exaxis_status[2].exAxisALM;
        msg.exaxistatus1[4] = ctrl_state.exaxis_status[2].exAxisFLERR;
        msg.exaxistatus1[5] = ctrl_state.exaxis_status[2].exAxisNLMT;
        msg.exaxistatus1[6] = ctrl_state.exaxis_status[2].exAxisPLMT;
        msg.exaxistatus1[7] = ctrl_state.exaxis_status[2].exAxisAbsOFLN;
        msg.exaxistatus1[8] = ctrl_state.exaxis_status[2].exAxisOFLIN;
        msg.exaxistatus1[9] = ctrl_state.exaxis_status[2].exAxisHomeStatus;
        ...
        msg.exaxistatus1[3] = ctrl_state.exaxis_status[3].exAxisALM;
        msg.exaxistatus1[4] = ctrl_state.exaxis_status[3].exAxisFLERR;
        msg.exaxistatus1[5] = ctrl_state.exaxis_status[3].exAxisNLMT;
        msg.exaxistatus1[6] = ctrl_state.exaxis_status[3].exAxisPLMT;
        msg.exaxistatus1[7] = ctrl_state.exaxis_status[3].exAxisAbsOFLN;
        msg.exaxistatus1[8] = ctrl_state.exaxis_status[3].exAxisOFLIN;
        msg.exaxistatus1[9] = ctrl_state.exaxis_status[3].exAxisHomeStatus;
